...
export DOCKER_ENABLE_WRITE_TOOLS="false"
export DOCKER_ALLOWED_CONTAINERS="api,worker"
export DOCKER_ALLOWED_NETWORKS="app-net"
export DOCKER_ALLOWED_VOLUMES="app-data"
export DOCKER_COMPOSE_PROJECTS='{"app":"/srv/app"}'
export DOCKER_MAX_COMPOSE_CONTAINERS="100"
export DOCKER_EVENTS_LOOKBACK_MINUTES="15"
export DOCKER_MAX_EVENT_LOOKBACK_MINUTES="60"
export GITLAB_TOKEN="..."
...
https://mcp.example.com/mcp/docker
